...
classMap = {}
classMap['smurf'] = 'DoS'
classMap['neptune'] = 'DoS'
classMap['back'] = 'DoS'
classMap['satan'] = 'probe'
classMap['ipsweep'] = 'probe'
classMap['portsweep'] = 'probe'
classMap['warezclient'] = 'r2l'
classMap['teardrop'] = 'DoS'
classMap['pod'] = 'DoS'
classMap['nmap'] = 'probe'
classMap['guess_passwd'] = 'r2l'
classMap['buffer_overflow'] = 'u2r'
classMap['land'] = 'DoS'
classMap['warezmaster'] = 'r2l'
classMap['imap'] = 'r2l'
classMap['rootkit'] = 'u2r'
classMap['loadmodule'] = 'u2r'
classMap['ftp_write'] = 'r2l'
classMap['multihop'] = 'r2l'
classMap['phf'] = 'r2l'
classMap['perl'] = 'u2r'
classMap['spy'] = 'r2l'
...
for line in inputFile:
	...
	classVal = lineParts[41][0:lineParts[41].rfind('.')]
	if(classVal.startswith('normal')):
		newLine = newLine + ' ' + 'normal'
	else:
		newLine = newLine + ' ' + classMap[classVal]
